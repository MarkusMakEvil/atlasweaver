...
```sh
uv tool install 'git+https://github.com/MarkusMakEvil/atlasweaver.git@v0.3.3'
uv tool install 'graphifyy==0.9.48'
graphify install --platform codex
git clone --depth 1 --branch v0.3.3 https://github.com/MarkusMakEvil/atlasweaver.git
cd atlasweaver
